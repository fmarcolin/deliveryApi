defmodule DeliveryApi.ViaCep.ClientTest do
  ...
  describe "get_cep_info/1" do
    ...
    test "when the cep is invalid, returns an error", %{bypass: bypass} do
      ...
      expected_response =
        {:error, %DeliveryApi.Error{result: "Invalid CEP", status: :bad_request}}
    ...
    test "when the cep was not found, returns an error", %{bypass: bypass} do
      ...
      expected_response =
        {:error, %DeliveryApi.Error{result: "CEP not found", status: :not_found}}
    ...
    test "when there is a generic error, returns an error", %{bypass: bypass} do
      ...
      expected_response =
        {:error, %DeliveryApi.Error{result: :econnrefused, status: :bad_request}}
